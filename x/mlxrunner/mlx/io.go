...
func LoadAll(root *model.Root, pattern string, states map[string][]*Tensor, afterLoadFuncs []func() error) error {
	...
	Eval(slices.Concat(slices.Collect(maps.Values(states))...)...)
